   ...
   <div class="container">
    <div class="form-sections">
      ...
      <div class="Form-left">
        ...
        <p>Contact us for any suggestion about our website)</p><br>

        <!--first Heading -->
        <h4>ADDRESS</h4>
         <span>A.P Shah Institute Of Technology , Thane - 321402</span>
         <hr><br><br>

         <!--second Heading -->
        <h4>PHONE</h4>
         <span>(+91)9712998877</span>
         <hr><br><br>

       <!--third Heading -->
        <h4>EMAIL</h4>
         <span>ayushnayak823@gmail.com</span>
         <hr> <br>
